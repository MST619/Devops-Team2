...
def test_ExitAfterGameSetup_Pass1_benchmark(monkeypatch):
    runtimings = {}
    totaltime = 0
    ...
    for x in loop:
        for i in range(x):
            ...
            timetaken = ts.test_ExitAfterGameSetup_Pass1(monkeypatch)
    ...
    print("\nPerformance Test Results for Exit After Game Setup Functionality:")
    print("------------------------------------------------------------------")
