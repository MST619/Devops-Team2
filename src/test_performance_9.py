...
def test_PlayGameAllChooseBuilding1_benchmark(monkeypatch):
    runtimings = {}
    totaltime = 0
    ...
    for x in loop:
        for i in range(x):
            ...
            timetaken = ts.test_PlayGameAllChooseBuilding1(monkeypatch)
    ...
    print("\nPerformance Test Results for Play Game All Choose Random Building 1 Functionality:")
    print("------------------------------------------------------------------")
