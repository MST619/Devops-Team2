...
def test_SaveNewGameAndFinishLoadedGame2_benchmark(monkeypatch):
    runtimings = {}
    totaltime = 0
    ...
    for x in loop:
        for i in range(x):
            ...
            timetaken = ts.test_SaveNewGameAndFinishLoadedGame2(monkeypatch)
    ...
    print("\nPerformance Test Results for Save New Game And Finish Loaded Saved Game Functionality (Random Building 2):")
    print("------------------------------------------------------------------")
