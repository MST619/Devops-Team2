...
def test_SaveNewGameAndLoadGame_benchmark(monkeypatch):
    runtimings = {}
    totaltime = 0
    ...
    for x in loop:
        for i in range(x):
            ...
            timetaken = ts.test_SaveNewGameAndLoadGame(monkeypatch)
    ...
    print("\nPerformance Test Results for Save New Game And Load Saved Game Functionality:")
    print("------------------------------------------------------------------")
