...
def test_ExitAfterNewGameFirstMove1_Pass_benchmark(monkeypatch):
    runtimings = {}
    totaltime = 0
    ...
    for x in loop:
        for i in range(x):
            ...
            timetaken = ts.test_ExitAfterNewGameFirstMove1_Pass(monkeypatch)
    ...
    print("\nPerformance Test Results for Exit After New Game First Move Random Building 1 Test (Correct Inputs) Functionality:")
    print("------------------------------------------------------------------")
