...
def test_ExitAfterNewGameFirstMove2_Pass_benchmark(monkeypatch):
    runtimings = {}
    totaltime = 0
    ...
    for x in loop:
        for i in range(x):
            ...
            timetaken = ts.test_ExitAfterNewGameFirstMove2_Pass(monkeypatch)
    ...
    print("\nPerformance Test Results for Exit After New Game First Move RandBuilding2 Test (Correct Inputs) Functionality:")
    print("------------------------------------------------------------------")
