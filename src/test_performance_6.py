...
def test_ExitAfterNewGameFirstMove1_Fail_benchmark(monkeypatch):
    runtimings = {}
    totaltime = 0
    ...
    for x in loop:
        for i in range(x):
            ...
            timetaken = ts.test_ExitAfterNewGameFirstMove1_Fail(monkeypatch)
    ...
    print("\nPerformance Test Results for Exit After New Game First Move Random Building 1 Test (Wrong Inputs) Functionality:")
    print("------------------------------------------------------------------")
